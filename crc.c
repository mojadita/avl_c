...
CRC_STATE do_crc(CRC_STATE state, CRC_BYTE *buff, size_t nbytes, CRC_TABLE table)
{
	CRC_STATE index;
...
CRC_STATE add_crc(CRC_STATE state, CRC_BYTE *buff, size_t nbytes, CRC_TABLE table)
{
	int i;
	CRC_STATE res;
